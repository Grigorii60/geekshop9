...
class ShopUserProfile(models.Model):
    ...
    GENDER_CHOICES = (
        (MALE, 'М'),
        #первое в базу, второе отображение и через choices запрос select
        (FEMALE, 'Ж'),
    )
...
#работа с сигналами(тригер), привязка к классу, в отдельный файл
...
#users_fix, потом миграции, переходим в формы